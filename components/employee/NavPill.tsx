...
// Floating pill navigation — highlighted based on current route
// Extracted as Client Component since it uses usePathname (Server Component cannot)
            ...
            <Link href={link.href}>
              <div
                ...
                style={{
                  background: isActive
                    ...
                    : 'transparent',
                  // Active state gets a subtle cyan shadow
                  boxShadow: isActive
              ...
              >
                <Icon
                  ...
                  style={{
                    color: isActive ? 'var(--orbit-cyan)' : 'var(--orbit-navy)',
